...
class _EstadoTelaJogoDeDados extends State<TelaJogadordeDados> {
  ...
  int _calcularPontuacao(List<int> lancamentos) {
    ...
    //toSet remove os números repetídos
    if (valoresUnicos == 1) {
      //Ex: [5,5,5]. Três iguais = 3x a soma
      return soma * 3;
    } else if (valoresUnicos == 2) {
      //Ex: [4,4,1]. Dois iguais = 2x a soma
      return soma * 2;
    } else {
      //Ex: [1,3,6]. Todos diferentes = soma pura.
      return soma;
    }
  }
...
//declara a função e devolve um widget: recebe nome jogador, lancamentos: os 3 valores do dado
  Widget _construirColunaJogador(String nome, List<int> lancamentos){
    return Expanded(//pega todo o espaço disponivel dentro de um row ou column
      child: Column(
        children: [
          ...
          Row(
            ...
            children: lancamentos.map((valor){
              //map transforma o número do dado em widget de imagem
              return Padding(
